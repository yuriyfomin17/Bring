package com.nimofy.applicationContextTest;

import com.nimofy.applicationContext.MessageServiceDemo;
import com.nimofy.applicationContext.PrinterServiceDemo;
import com.nimofy.applicationContext.applicationContext.ApplicationContextImpl;
import com.nimofy.applicationContext.exceptions.NoSuchBeanException;
import com.nimofy.applicationContext.exceptions.NoUniqueBeanException;
import com.nimofy.applicationContextTest.testBeansCorrectMap.SameBean1;
import com.nimofy.applicationContextTest.testBeansCorrectMap.SameBean2;
import com.nimofy.applicationContextTest.testBeansCorrectMap.SameBeanInterface;
...
public class ApplicationContextTest {
    private final String packageName = "com.nimofy.applicationContext";
    ...
    class AppplicationContextInterfaceTest {
        ...
        void getNoUniqueBeanException() throws Exception {
            String testBeansPackageName = "com.nimofy.applicationContextTest.testBeansCorrectMap";
    ...
    class ApplicationContextAutowiringTest {
        ...
        void autowiringGetNoUniqueBeanException(){
            String testBeansPackageName = "com.nimofy.applicationContextTest.testBeanAutowireNoUniqueBeanException";
        ...
        void autowiringGetNoSuchBeanException(){
            String testBeansPackageName = "com.nimofy.applicationContextTest.testBeanAutowireNoSuchBeanException";
